...
async function forecastWeather(city) {
  ...
  var day2_im =weather-forecasting/"+data.days[2].icon + ".png";
  ...
  var day3_im =weather-forecasting/"+data.days[3].icon + ".png";
  ...
  var day4_im = weather-forecasting/"+data.days[4].icon + ".png";
  ...
  var day5_im =weather-forecasting/"+data.days[5].icon + ".png";
